...
char tk_char_single_comment_end(e_tkz_lang_type_t tkz_type);
...
static inline bool tk_lang_c_pctt_char_p(char c);
...
static inline char tk_lang_c_single_comment_end(void);
