...
bool token_structure_illegal_p(s_token_t *token);
...
static inline bool token_structure_illegal_ip(s_token_t *token);
static inline bool token_structure_legal_ip(s_token_t *token);
...
static inline void token_language_c_keyword_seek(s_trie_tree_t *keyword_trie, s_token_t *token);
...
uint32 token_language_c_identifier_match(s_nfa_t *nfa, s_trie_tree_t *keyword_trie, s_token_t *token_head, char *buf);
