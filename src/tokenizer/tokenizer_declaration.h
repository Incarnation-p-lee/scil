...
static inline bool tkz_io_buf_loaded_p(s_tkz_io_buffer_t *tkz_io_buf, e_tkz_lang_type_t tkz_type);
...
static inline bool tkz_io_buf_secondary_limit_reached_p(s_tkz_io_buffer_t *tkz_io_buf);
...
static inline void tkz_file_io_buf_process(s_io_buffer_t *io_buffer, s_tkz_lang_t *tkz_lang, s_tk_t *tk_head);
...
static inline void tkz_io_buf_secondary_index_set(s_tkz_io_buffer_t *tkz_io_buf);
