...
static inline uint32 tokenizer_language_c_token_match(s_tokenizer_language_t *tkz_language, s_tk_t *token_head, char *buf);
...
static inline void tokenizer_file_io_buffer_process(s_io_buffer_t *io_buffer, s_tokenizer_language_t *tkz_language, s_tk_t *token_head);
...
static inline void tokenizer_io_block_language_c_match(s_tokenizer_language_t *tkz_language, s_tk_t *token_head, s_io_block_t *io_block);
static inline void tokenizer_io_block_print(s_io_block_t *io_block);
static inline void tokenizer_io_block_process(s_tokenizer_language_t *tkz_language, s_tk_t *token_head, s_io_block_t *io_block);
