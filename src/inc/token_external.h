...
extern bool token_structure_illegal_p(s_token_t *token);
extern bool token_structure_legal_p(s_token_t *token);
extern s_token_t * token_list_node_next(s_token_t *token);
extern s_token_t * token_list_node_previous(s_token_t *token);
...
extern uint32 token_language_c_identifier_match(s_nfa_t *nfa, s_trie_tree_t *keyword_trie, s_token_t *token_head, char *buf);
