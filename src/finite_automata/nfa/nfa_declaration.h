...
static inline bool nfa_closure_dp_structure_legal_p(s_fa_closure_dp_t *closure_dp);
...
static inline s_fa_closure_dp_t * nfa_closure_dp_create(uint32 dp_size);
...
static inline uint32 nfa_engine_pattern_match_backtrack(s_nfa_t *nfa, s_fa_closure_dp_t *closure_dp);
...
static inline void nfa_closure_copy(s_fa_closure_t *closure_dest, s_fa_closure_t *closure_src);
static inline void nfa_closure_destroy(s_fa_closure_t **closure);
static inline void nfa_closure_dp_add(s_fa_closure_dp_t *closure_dp, s_fa_closure_t *closure);
static inline void nfa_closure_dp_destroy(s_fa_closure_dp_t **closure_dp);
