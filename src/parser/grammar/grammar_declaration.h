...
static inline void grammar_language_print(s_gr_lang_t *gr_lang);
...
static inline void grammar_production_body_list_print(s_gr_body_list_t *gr_body_list);
static inline void grammar_production_body_print(s_gr_body_t *gr_body);
...
static inline void grammar_production_print(s_gr_pdt_t *gr_pdt, uint32 idx);
